    ...
    return (
        <div className="divReserva">
            ...
            <div className="containerMDP">
                ...
                <div>
                    <h2 className="Reservas-pagos">Subtotal:</h2>
                    <h2 className="Reservas-pagos">Descuento:</h2>
                    <h2 className="Reservas-pagos">Total:</h2>
                </div>
                <hr />
                <div>
                    <h2 className="Reservas-pagos">Pago:</h2>
                    <h2 className="Reservas-pagos">Cambio:</h2>
                </div>
